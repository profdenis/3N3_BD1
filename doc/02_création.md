...
Une clé simple est déclarée à l'aide d'une contrainte de colonne, comme nous
l'avons déjà vue :
...
Dans l'interface texte de sqlite3, le commit est fait automatiquement après le
`insert`.
